...
<body>
    ...
    <section class="section" style="padding-bottom: 100px;">
        <div class="container">
            ...
            <p class="fade-in delay-1" style="max-width: 800px; margin-bottom: 50px; font-size: 1.1rem;">
                Всегда рады помочь вам с выбором автомобиля. Приезжайте в гости или свяжитесь с нами удобным способом.
            </p>
            
            <div class="contact-info">
                <div class="contact-card fade-in">
                    <h3 class="contact-title"><i class="fas fa-map-marker-alt contact-icon"></i> Адрес</h3>
                    <ul class="contact-list">
                        <li class="contact-item">
                            <i class="fas fa-building contact-icon"></i>
                            <span>г. Москва, ул. Автозаводская, д. 23, шоурум EMAX</span>
                        </li>
                        <li class="contact-item">
                ...
                <div class="contact-card fade-in delay-1">
                    <h3 class="contact-title"><i class="fas fa-phone-alt contact-icon"></i> Телефоны</h3>
                    <ul class="contact-list">
                        <li class="contact-item">
                        ...
                        <li class="contact-item">
                            ...
                            <span>+7 (800) 123-45-67 (бесплатно по РФ)</span>
                        </li>
                    </ul>
                </div>
                <div class="contact-card fade-in delay-2">
                    <h3 class="contact-title"><i class="fas fa-envelope contact-icon"></i> Электронная почта</h3>
                    <ul class="contact-list">
                        <li class="contact-item">
                            <i class="fas fa-inbox contact-icon"></i>
                            <span>info@emax-auto.ru</span>
                        </li>
                        <li class="contact-item">
                            <i class="fas fa-headset contact-icon"></i>
                            <span>support@emax-auto.ru (техподдержка)</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="contact-form fade-in delay-3" style="margin-top: 50px;">
                <h3 class="contact-title" style="margin-bottom: 20px;"><i class="fas fa-paper-plane contact-icon"></i> Остались вопросы?</h3>
                <form id="feedbackForm" style="display: grid; gap: 20px;">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        <div>
                            <label for="name" style="display: block; margin-bottom: 8px; font-weight: 500;">Ваше имя</label>
                            <input type="text" id="name" name="name" required style="width: 100%; padding: 12px; border-radius: 6px; border: 1px solid rgba(255,255,255,0.1); background-color: rgba(255,255,255,0.05); color: white;">
                        </div>
                        <div>
                            <label for="phone" style="display: block; margin-bottom: 8px; font-weight: 500;">Телефон</label>
                            <input type="tel" id="phone" name="phone" required style="width: 100%; padding: 12px; border-radius: 6px; border: 1px solid rgba(255,255,255,0.1); background-color: rgba(255,255,255,0.05); color: white;">
                        </div>
                    </div>
                    <div>
                        <label for="message" style="display: block; margin-bottom: 8px; font-weight: 500;">Ваш вопрос</label>
                        <textarea id="message" name="message" rows="4" style="width: 100%; padding: 12px; border-radius: 6px; border: 1px solid rgba(255,255,255,0.1); background-color: rgba(255,255,255,0.05); color: white;"></textarea>
                    </div>
                    <button type="submit" class="btn btn-accent" style="justify-self: start; margin-top: 10px;">
