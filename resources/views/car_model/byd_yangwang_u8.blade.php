...
<head>
    ...
    <title>3D Просмотр - BYD Yangwang U8 | EMAX</title>
...
<body>
    <div class="viewer-container">
        ...
        <div class="model-section">
            ...
            <div class="byd-badge">FLAGSHIP</div>
            
            <model-viewer 
                src="models/byd_yangwang_u8.glb" 
                alt="3D модель BYD Yangwang U8"
                auto-rotate
                camera-controls
                ar
        ...
        <div class="specs-panel" id="specsPanel">
            ...
            <div class="panel-header fade-in">
                <h1 class="panel-title">BYD Yangwang U8</h1>
            </div>
            
            <p class="car-description fade-in delay-1">
                Флагманский люксовый внедорожник с революционной технологией E4. 
                Сочетание роскоши, мощности и инновационных решений в электромобилестроении.
            </p>
            ...
            <ul class="specs-list">
                ...
                <li class="spec-item fade-in delay-2">
                    ...
                    <span class="spec-value">Plug-in Hybrid (E4)</span>
                </li>
                <li class="spec-item fade-in delay-3">
                    <span class="spec-name">Мощность</span>
                    <span class="spec-value">1184 л.с. (комбинир.)</span>
                </li>
                <li class="spec-item fade-in delay-4">
                    <span class="spec-name">Разгон 0-100 км/ч</span>
                    <span class="spec-value">3.6 сек</span>
                </li>
                <li class="spec-item fade-in delay-1">
                    <span class="spec-name">Запас хода (EV)</span>
                    <span class="spec-value">180 км</span>
                </li>
                <li class="spec-item fade-in delay-2">
                    <span class="spec-name">Привод</span>
                    <span class="spec-value">4WD (4 электромотора)</span>
                </li>
                <li class="spec-item fade-in delay-3">
                    <span class="spec-name">Водная защита</span>
                    <span class="spec-value">IP68 (плавает)</span>
                </li>
                <li class="spec-item fade-in delay-4">
                    <span class="spec-name">Колесная база</span>
                    <span class="spec-value">3050 мм</span>
                </li>
            </ul>
            
            <div class="price-container fade-in delay-2">
                <div class="price-label">Цена от</div>
                <div class="price-value">15 990 000 ₽</div>
            </div>
            ...
            <div class="action-buttons">
                ...
                <button class="action-button secondary-button fade-in delay-2">
                    <i class="fas fa-file-contract"></i> Консультация
                </button>
                <button class="action-button secondary-button fade-in delay-3">
                    <i class="fas fa-video"></i> Видеообзор
                </button>
            </div>
        </div>
    </div>
